...
│   └── images/                  # 论文图片
 ├── sessions/                    # 学习会话记录
  │   ├── 2026-01-14/             # 2026-01-14 的会话
  │   │   └── session-notes.md    # 详细学习记录
  │   ├── 2026-01-15/             # 2026-01-15 的会话
  │   │   └── session-notes.md    # 详细学习记录
  │   ├── 2026-01-16/             # 2026-01-16 的会话
  │       └── session-notes.md    # 详细学习记录
├── progress/                     # 学习进度追踪
...
### 查看学习历史
```bash
cat sessions/2026-01-16/session-notes.md
```

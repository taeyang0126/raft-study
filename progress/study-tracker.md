...
- **影响范围**：状态机执行、客户端响应
- **关联主题**：日志应用机制
- **学习计划**：日志复制机制学习后（2025-01-17）

#### 2. nextIndex 和 matchIndex 的具体维护逻辑
- **状态**：待学习
- **影响范围**：日志复制效率、日志一致性
- **关联主题**：日志复制机制
- **学习计划**：AppendEntries RPC 学习后（2025-01-17）
...
#### 2025-01-16（计划）
- ~~[ ] AppendEntries RPC 的详细流程~~ ✅ 已完成（2025-01-15）
  - ~~[ ] RPC 参数和返回值~~ ✅
  - ~~[ ] 一致性检查机制~~ ✅
  - ~~[ ] 日志复制流程~~ ✅
- ~~[ ] Leader 如何修复 Follower 的日志不一致~~ ✅ 已完成（2025-01-15）
  - ~~[ ] nextIndex 的初始化和维护~~ ✅
  - ~~[ ] 递减重试机制~~ ✅
  - ~~[ ] 最终达成一致~~ ✅
...
### 第 2 周：实现设计（2025-01-22 ~ 2025-01-28）
...
### 第 3 周：高级特性（2025-01-29 ~ 2025-02-04）

#### 2025-01-29 ~ 2025-02-04（计划）
- [ ] 日志压缩（Snapshot）
- [ ] 集群成员变化
- [ ] 客户端交互优化
- [ ] 实际系统的考虑
...
### 第 4 周：实践和深化（2025-02-05 ~ 2025-02-11）

#### 2025-02-05 ~ 2025-02-11（计划）
- [ ] 实际分布式系统设计
- [ ] Raft 在实际项目中的应用
- [ ] 常见问题和解决方案
- [ ] 性能优化实践
...
- [ ] 2025-01-17：完全理解日志复制机制（commitIndex 和 lastApplied 的关系）
...
### 下次会话准备
- ~~准备 AppendEntries RPC 的完整流程演示~~ ✅ 已完成
- ~~准备 nextIndex 和 matchIndex 维护的详细示例~~ ✅ 已完成
- 准备 commitIndex 和 lastApplied 关系的场景演示
- 设计日志应用到状态机的详细流程
- 设计客户端交互的场景演示

...
### 高严重程度（已解决）
- [x] 提交规则的完整理解（2025-01-16）
- [x] commitIndex 的更新机制（2025-01-16）
- [x] Leader 如何知道 Follower 的 lastIndex（通过 matchIndex）（2025-01-16）
- [x] 提交 vs 应用的区别（2025-01-16）
- [x] 四个机制如何配合确保安全性（2025-01-16）
...
### 高信心度
- [x] 提交规则 (2025-01-16) - 理解为什么只能提交当前任期日志，构造了正确的危险场景
- [x] commitIndex 的更新机制 (2025-01-16) - 理解 Leader 如何通过 matchIndex 知道 Follower 的 lastIndex
- [x] 提交 vs 应用 (2025-01-16) - 理解提交是 Raft 层概念，应用是状态机层概念
- [x] 四个机制的配合逻辑 (2025-01-16) - 理解如何确保"已提交的日志不能被覆盖"

### 中高信心度
- [x] 危险场景的构造 (2025-01-16) - 能构造正确的危险场景说明提交规则的作用
...
- [x] 提交 vs 应用的区别（2025-01-16）
- [x] 四个机制如何配合确保安全性（2025-01-16）
- [x] commitIndex 和 lastApplied 的详细关系（2025-01-16）
- [x] lastApplied 的持久化方案（通过快照）（2025-01-16）
- [x] nextIndex 和 matchIndex 的优化策略（2025-01-16）
...
- [x] 提交 vs 应用 (2025-01-16) - 理解提交是 Raft 层概念，应用是状态机层概念
- [x] 四个机制的配合逻辑 (2025-01-16) - 理解如何确保"已提交的日志不能被覆盖"
- [x] commitIndex 和 lastApplied 的关系 (2025-01-16) - 理解两个变量分别代表什么，为什么需要两个变量
- [x] lastApplied 的持久化方案 (2025-01-16) - 理解通过快照解决 lastApplied 和状态机的一致性问题
- [x] nextIndex 和 matchIndex 的维护流程 (2025-01-16) - 准确总结初始化、发送、成功、失败的处理逻辑
- [x] nextIndex 和 matchIndex 的优化策略 (2025-01-16) - 理解指数退避方案，理解 nextIndex 的必要性

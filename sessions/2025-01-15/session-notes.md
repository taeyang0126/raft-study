...
### 高信心度
- [x] 选举限制规则 (2025-01-15) - 完全理解交集原理和投票条件
- [x] 提交规则 (2025-01-15) - 理解为什么只能提交当前任期日志
- [x] 日志匹配特性 (2025-01-15) - 理解递归证明和一致性保证
- [x] AppendEntries RPC 的完整流程 (2025-01-15) - 理解参数、返回值、一致性检查
- [x] Leader 如何修复 Follower 的日志不一致 (2025-01-15) - 理解 nextIndex 初始化、递减重试、最终达成一致
- [x] commitIndex 的作用 (2025-01-15) - 理解已提交日志的标记和状态机应用机制
- [x] Leader 的日志组成 (2025-01-15) - 理解包含已提交和未提交日志

### 中高信心度
- [x] 两个机制的配合 (2025-01-15) - 理解如何共同保证安全性
- [x] 三个机制配合 (2025-01-15) - 选举限制、提交规则、日志匹配特性共同保证安全性
- [x] 日志复制的完整机制 (2025-01-15) - 理解从 Leader 到 Follower 的完整流程
